#add a methof to the BST class called in_order which will print all elements in order.
#
...
class BST:
    ...
    def recursion(self, ptr):
        if ptr != None:
            print(ptr.item, "", end = "")
            self.recursion(ptr.left)
            self.recursion(ptr.right)
